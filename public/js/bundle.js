...
exports.Axios = Axios;
},{"./lib/axios.js":"../../node_modules/axios/lib/axios.js"}],"../../node_modules/sweetalert2/dist/sweetalert2.all.js":[function(require,module,exports) {
var define;
var global = arguments[3];
/*!
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          _Toast = _sweetalert.default.mixin({
            toast: true,
            position: 'top-end',
            showConfirmButton: false,
            timer: 2000,
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          _Toast2 = _sweetalert.default.mixin({
            toast: true,
            position: 'top-end',
            showConfirmButton: false,
            timer: 2000,
...
},{"axios":"../../node_modules/axios/index.js","sweetalert2":"../../node_modules/sweetalert2/dist/sweetalert2.all.js"}],"app.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.itemCtrl = exports.UI = exports.StorageCtrl = void 0;
var StorageCtrl = function () {
  ...
  return {
    ...
    deleteItemFromStorage: function deleteItemFromStorage(id) {
      var userID = JSON.parse(localStorage.getItem('userID'));
      var items = JSON.parse(localStorage.getItem('items' + userID));
...
// UI Controller
exports.StorageCtrl = StorageCtrl;
var UI = function () {
  var UISelectors = {
  ...
  return {
    populateItemList: function populateItemList(items) {
      ...
      items.forEach(function (item) {
        html += "\n        <tr id=\"item-".concat(item.id, "\">\n          <td>").concat(item.name, "</td>\n          <td>").concat(item.calories, "</td>\n          <td>").concat(item.fat, "</td>\n          <td>").concat(item.carbohydrates, "</td>\n          <td>").concat(item.protein, "</td>\n          <td class=\"delete-btn fa fa-trash\"></td>\n        </tr>\n        ");
      });
    ...
    addListMeal: function addListMeal(item) {
      var tableRow = document.createElement('tr');
      tableRow.id = "item-".concat(item.id);
      tableRow.innerHTML = "\n      <td>".concat(item.name, "</td>\n      <td>").concat(item.calories, "</td>\n      <td>").concat(item.fat, "</td>\n      <td>").concat(item.carbohydrates, "</td>\n      <td>").concat(item.protein, "</td>\n      <td class=\"delete-btn fa fa-trash\"></td>");
      document.querySelector(UISelectors.itemList).insertAdjacentElement('Afterbegin', tableRow);
    },
    showTotalNutrient: function showTotalNutrient(getTotalNutrient) {
      var html = '';
      html += "\n        <li class=\"btn blue darken-1\">Calories: ".concat(getTotalNutrient[0], "</li>\n        <li class=\"btn waves-effect waves-light\">Fat: ").concat(getTotalNutrient[1], "</li>\n        <li class=\"btn amber accent-4\">Carbohydrates: ").concat(getTotalNutrient[2], "</li>\n        <li class=\"btn deep-orange accent-4\">Protein: ").concat(getTotalNutrient[3], "</li>\n      ");
      document.querySelector(UISelectors.totalCount).innerHTML = html;
    },
    deleteListItem: function deleteListItem(id) {
      var itemId = "#item-".concat(id);
...
var itemCtrl = function () {
  var Item = function Item(id, name, calories, fat, carbohydrates, protein) {
    this.id = id, this.name = name, this.calories = calories, this.fat = fat, this.carbohydrates = carbohydrates, this.protein = protein;
  };
  var data = {
  ...
  return {
    ...
    addItem: function addItem(name, calories, fat, carbohydrates, protein) {
      // Create Id
      var ID;
      // Create ID
      ...
      // Create new Item 
      var newItem = new Item(ID, name, calories, fat, carbohydrates, protein);

      // Add items Array
      data.items.push(newItem);
      return newItem;
    },
    getTotalNutrients: function getTotalNutrients() {
      var totalCal = 0;
      var totalFat = 0;
      var totalCar = 0;
      var totalPro = 0;
      ...
      return [data.totalCalories, data.totalFat, data.totalCarbohydrates, data.totalProtein];
    },
...
exports.itemCtrl = itemCtrl;
},{}],"resetPassword.js":[function(require,module,exports) {
"use strict";
...
var resetPassword = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(token, password) {
    var res, Toast, _Toast;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
...
},{"axios":"../../node_modules/axios/index.js","sweetalert2":"../../node_modules/sweetalert2/dist/sweetalert2.all.js"}],"food.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getFoodName = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _sweetalert = _interopRequireDefault(require("sweetalert2"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var getFoodName = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(foodItem) {
    var res, Toast;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "http://127.0.0.1:5000/api/v1/foods/".concat(foodItem)
          });
        case 3:
          res = _context.sent;
          if (!(res.data.status === 'success')) {
          ...
          return _context.abrupt("return", res.data.data.foodItem);
        case 6:
          _context.next = 12;
          break;
        case 8:
  ...
  return function getFoodName(_x) {
    return _ref.apply(this, arguments);
  };
}();
exports.getFoodName = getFoodName;
},{"axios":"../../node_modules/axios/index.js","sweetalert2":"../../node_modules/sweetalert2/dist/sweetalert2.all.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
if (RegisterForm) {
  RegisterForm.addEventListener('submit', function (e) {
    ...
    (0, _login.register)(name, email, password);
...
if (forgetPassword) {
  forgetPassword.addEventListener('click', /*#__PURE__*/function () {
                ...
                return new Promise(function (resolve, reject) {
                  if (email) {
                    (0, _axios.default)({
                      ...
                      _sweetalert.default.showValidationMessage("Request failed: ".concat(error.response.data.message));
                      reject();
                    });
                  }
                });
...
if (changePassword) {
  changePassword.addEventListener('submit', function (e) {
    ...
    var password = document.getElementById('password').value;
    (0, _resetPassword.resetPassword)(token, password);
    document.getElementById('password').value = '';
  });
}
if (logOut) {
...
var AppCtrl = function () {
  var loadEventListeners = function loadEventListeners() {
    var UISelectors = _app.UI.getSelectors();
  ...
  var AddMealSubmit = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
      var input, arr, i, inputRes, foodItems, newItem, getTotalNutrient;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            input = _app.UI.getItemInput();
            e.preventDefault();
            _context2.prev = 2;
            if (!(input.name !== '')) {
              _context2.next = 17;
            ...
            arr = input.name.split(" ");
            for (i = 0; i < arr.length; i++) {
              arr[i] = arr[i].charAt(0).toUpperCase() + arr[i].slice(1);
            }
            inputRes = arr.join(" ");
            _context2.next = 9;
            return (0, _food.getFoodName)(inputRes);
          case 9:
            foodItems = _context2.sent;
            newItem = _app.itemCtrl.addItem(foodItems.name, foodItems.calories, foodItems.fat, foodItems.carbohydrate, foodItems.protein);
            _app.UI.addListMeal(newItem);
            _app.itemCtrl.setCurrentItem(newItem);

            // Get the total Nutrition
            getTotalNutrient = _app.itemCtrl.getTotalNutrients();
            _app.UI.showTotalNutrient(getTotalNutrient);

            // Store In LS
            _app.StorageCtrl.storeItem(newItem);
            // Clear Field
            _app.UI.clearInput();
          case 17:
            _context2.next = 23;
    ...
    return function AddMealSubmit(_x2) {
      return _ref2.apply(this, arguments);
    };
  }();
  var DeleteItemMeal = function DeleteItemMeal(e) {
    if (e.target.classList.contains('delete-btn')) {
      ...
      var itemId = _app.itemCtrl.getItemById(id);
      _app.itemCtrl.setCurrentItem(itemId);
      var currentItem = _app.itemCtrl.getCurrentItem();

      // Delete from data structure
      _app.itemCtrl.deleteItem(currentItem.id);

      // Delete from the UI
      _app.UI.deleteListItem(currentItem.id);
      var getTotalNutrient = _app.itemCtrl.getTotalNutrients();
      _app.UI.showTotalNutrient(getTotalNutrient);

      // Delete from local storage
      _app.StorageCtrl.deleteItemFromStorage(currentItem.id);
    }
    e.preventDefault();
  };
  var clearAllItemsClick = function clearAllItemsClick(e) {
    _app.itemCtrl.clearAllItems();
    ...
    _app.StorageCtrl.clearItemsFromStorage();
    e.preventDefault();
  };
  return {
    init: function init() {
      var item = _app.itemCtrl.getItems();
      _app.UI.populateItemList(item);
      var getTotalNutrient = _app.itemCtrl.getTotalNutrients();
      _app.UI.showTotalNutrient(getTotalNutrient);
